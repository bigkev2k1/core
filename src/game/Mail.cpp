...
void WorldSession::SendExternalMails()
{
    ...
    else
    {
        ...
        do
        {
            ...
            ObjectGuid receiver_guid = fields[1].GetUInt64();
            ...
            if (id != last_id)
            {
                ...
                if (last_id != 0)
                {
                    ...
                    mail->SendMailTo( MailReceiver(last_receiver_guid), MailSender(0, MAIL_STATIONERY_GM), MAIL_CHECK_MASK_RETURNED);
                    delete mail;
